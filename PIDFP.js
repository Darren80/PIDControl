...
class PID {
    ...
    constructor(proportionalGain, integralGain, derivativeGain, outputLowerLimit = -100, outputUpperLimit = 100) {
        ...
        this.deltaTime = 1; // Time since last update (in milliseconds)
    ...
    calcIntegralError() {
        ...
        // (Anti-windup based on setpoint crossing)
    ...
    // Back-calculation of integral term on setpoint crossing
    backCalculateIntegralErrorOnSetpoint() {

    }

    // Back-calculation of integral term on output saturation
